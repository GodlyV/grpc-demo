...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x73, 0x22, 0x29, 0x0a, 0x0d, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x73,
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	3, // 5: greet_service.GreetService.SayHelloServerStreaming:output_type -> greet_service.HelloResponse
	4, // 6: greet_service.GreetService.SayHelloClientStreaming:output_type -> greet_service.MessageList
	3, // 7: greet_service.GreetService.SayHelloBidirectionalStreaming:output_type -> greet_service.HelloResponse
